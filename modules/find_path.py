...
class FindPathPage(ttk.Frame):
    ...
    def setup_styles(self):
        style = ttk.Style()
        style.configure("Start.TButton", background="#4CAF50", foreground="white", font=("Arial", 12))
        style.configure("Stop.TButton", background="#f44336", foreground="white", font=("Arial", 12))
    ...
    def apply_theme(self, theme_name):
        ...
        if theme_name == '粉色':
            ...
            # 按钮样式
            for btn in self.button_refs:
                btn.configure(background="#FFB6C1", foreground="#FF1493", font=("Arial", 12))
            self.scan_file_button.config(background="#FFB6C1", foreground="#FF1493", font=("Arial", 12))
            self.scan_files_button.config(background="#FFB6C1", foreground="#FF1493", font=("Arial", 12))
            self.open_reports_btn.config(background="#FFB6C1", foreground="#FF1493", font=("Arial", 12))
            ...
            # 按钮样式
            for btn in self.button_refs:
                btn.configure(background="#BBE1FF", foreground="#1E6CB0", font=("Arial", 12))
            self.scan_file_button.config(background="#BBE1FF", foreground="#1E6CB0", font=("Arial", 12))
            self.scan_files_button.config(background="#BBE1FF", foreground="#1E6CB0", font=("Arial", 12))
            self.open_reports_btn.config(background="#BBE1FF", foreground="#1E6CB0", font=("Arial", 12))
            ...
            # 按钮样式
            for btn in self.button_refs:
                btn.configure(background="#bdc3c7", foreground="#2c3e50", font=("Arial", 12))
            self.scan_file_button.config(background="#bdc3c7", foreground="#2c3e50", font=("Arial", 12))
            self.scan_files_button.config(background="#bdc3c7", foreground="#2c3e50", font=("Arial", 12))
            self.open_reports_btn.config(background="#bdc3c7", foreground="#2c3e50", font=("Arial", 12))
        else:  # 默认主题
            self.output_box.tag_configure("red_tag", foreground="red")
            self.output_box.tag_configure("orange_tag", foreground="orange")
            self.output_box.tag_configure("green_tag", foreground="green")
            ...
            # 按钮样式
            for btn in self.button_refs:
                btn.configure(background="#e0e0e0", foreground="#333333", font=("Arial", 12))
            self.scan_file_button.config(background="#e0e0e0", foreground="#333333", font=("Arial", 12))
            self.scan_files_button.config(background="#e0e0e0", foreground="#333333", font=("Arial", 12))
            self.open_reports_btn.config(background="#e0e0e0", foreground="#333333", font=("Arial", 12))
        # 根据当前结果刷新显示
        self.update_output()
