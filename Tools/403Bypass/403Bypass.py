...
def make_request(url, headers=None, method='GET', data=None):
    try:
        ...
        if method == 'GET':
            ...
            response = requests.request('TRACE', url, headers=headers, verify=False, proxies=proxies)
...
def main():
    ...
    for headers, url in headers_tests:
        # headers['Cookie'] = "Hm_lvt_9e67da72985f8115e513e00952deed6b=1754289164; HMACCOUNT=66796BD57869F405; _gcl_au=1.1.181388603.1754289165; _gid=GA1.2.1292889224.1754289165; acIdAuthSession=c2ObGTvoILehbGrkYwCxVkq6bUshEdwIlHreM74pmnZ4b0wiGjrxMet9_cb08NdwYZMQgSt6oJ0; accessToken=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..8jEy9QeYy19JdumqMb1yujC0YsVlVdgnn1tWEsB7ehk; nickname=Bbdolt; hadAccept=1,2,3,4; Hm_lpvt_9e67da72985f8115e513e00952deed6b=1754290049; _ga_C9R87BNWFK=GS2.1.s1754289165$o1$g1$t1754290049$j48$l0$h0; _ga_Z9773KTN4F=GS2.1.s1754289165$o1$g1$t1754290049$j48$l0$h0; _ga=GA1.1.1276301318.1754289165; Hm_lvt_7603a613d643f4b2f117a767c07e34c0=1754290119; Hm_lpvt_7603a613d643f4b2f117a767c07e34c0=1754290119; RMID=68BE85F30ED9189857475E6880861AD9"
